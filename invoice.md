...
| **proforma_id**          | string   | proforma invoice ID, based on which regular invoice is issued. Invoice will get information about paid invoice. Multiple IDs can be set separated by comma (`1,2,3`). | |
